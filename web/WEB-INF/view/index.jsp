    ...
    <div id="container">
                ...
                <div class="loginForm">
                    <div class="innerLoginForm">
                        <form action="/login.do" method="post">
                            <div class="inputForm"><label for="userName"> Username <span
                                    class="indicates">*</span><span>  you may be: kamazz</span> </label>
                            ...
                            <div class="inputForm"><label for="password"> Password <span
                                    class="indicates">*</span><span>  kamazz</span> </label>
        ...
        <div class="content row">
            <div class="contentWrap">
                <p>
                    Java Enterprise проект с регистрацией/авторизацией. Пользователь может проверить свои знания по java
                    core, выбрать и пройти квиз из представленных тем и разделов. После пройденного квиза можно
                    посмотреть свой результатт с правельными ответами.</div>
        </div>
    </div>
</div>
</body>
