        ...
        <div class="content row">
            <div class="innerWrapContent">
                <form class="registerUserForm" action="/registerNewUser.do" method="post">
                    ...
                    <div class="registerUserDiv"><label for="userName"> Username <span
                            class="indicates">*</span></label>
                        <input class="textField" type="text" name="userName" id="userName" value="${InputUserNameValue}"
                               size="20"/>
                        <c:choose>
                    ...
                    <div class="registerUserDiv"><label for="password"> Password <span
                            class="indicates">*</span></label>
                    ...
                    <div class="registerUserDiv"><label for="invite"> Invite <span class="indicates">*</span></label>
                        <input class="textField" type="text" name="invite" id="invite" value="${InputInviteValue}"
                               size="20"/>
                        <c:choose>
                    ...
                    <div>
                        <input class="submitButton registerFormButton" type="submit" value="зарегистрироваться"
                               name="submit"/>
                    </div>
